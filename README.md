...
|--------|---------|
| Given | I've connected with the /create route and the form is showing. | 
| When | I fill the form with the following information: <br> name: Max <br> lastname: Mustermann <br> e-mail: <b>max.mustermann@sluz</b> <br> phone: +41 77 449 75 00 <br> loan package: example package 1000 <br> amount of instalments: 2 <br> I click on the create button. | 
...
|--------|---------|
| Given | I've connected with the /create route and the form is showing. | 
| When | I fill the form with the following information: <br> name: `<script>alert("You got hacked!!");</script>` <br> lastname: Mustermann <br> e-mail: max.mustermann@sluz.ch <br> phone: +41 77 449 75 00 <br> loan package: example package 1000 <br> amount of instalments: 2 <br> I click on the create button. | 
...
| When | I change the URL manually to one of the other routes. | 
